<div class="w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 mx-auto">
    ...
    <div class="flex flex-col md:flex-row gap-4 mt-4">
      <div class="md:w-3/4">
                ...
                <tr wire:key="{{$item->id}}">
                    <td class="py-4">
                      <div class="flex items-center">
                        <img class="h-16 w-16 mr-4" src="{{url('storage/'.$item->produto->imagens[0])}}" alt="{{$item->produto->nome}}">
                        <span class="font-semibold">{{$item->produto->nome}}</span>
                      </div>
                    </td>
        ...
        <div class="bg-white overflow-x-auto rounded-lg shadow-md p-6 mb-4">
          <h1 class="font-3xl font-bold text-slate-500 mb-3">Endereço de Envio</h1>
      ...
      <div class="md:w-1/4">
        <div class="bg-white rounded-lg shadow-md p-6">
          ...
          <div class="flex justify-between mb-2">
            <span>Subtotal</span>
            <span>{{Number::currency($item->pedido->valor_total, 'BRL')}}</span>
          </div>
          <div class="flex justify-between mb-2">
            <span>Taxas</span>
          ...
          <div class="flex justify-between mb-2">
            ...
            <span class="font-semibold">{{Number::currency($item->pedido->valor_total, 'BRL')}}</span>
          </div>
