                ...
                <div class="flex items-center justify-center w-full pb-6 space-x-4 md:justify-start">
                  <div class="flex flex-col items-start justify-start space-y-2">
                    <p class="text-lg font-semibold leading-4 text-left text-gray-800 dark:text-gray-400">
                      {{$pedido->endereco->full_name}}</p>
                    <p class="text-sm leading-4 text-gray-600 dark:text-gray-400">{{$pedido->endereco->rua}}, {{$pedido->endereco->bairro}}</p>
                    <p class="text-sm leading-4 text-gray-600 dark:text-gray-400">{{$pedido->endereco->cidade}}, {{$pedido->endereco->estado}}, {{$pedido->endereco->cep}}</p>
                    <p class="text-sm leading-4 text-gray-600 dark:text-gray-400">{{$pedido->endereco->referencia}}, {{$pedido->endereco->complemento}}</p>
                    <p class="text-sm leading-4 cursor-pointer dark:text-gray-400">Telefone: {{$pedido->endereco->celular}}</p>
                  </div>
                </div>
              </div>
            </div>
            <div class="flex flex-wrap items-center pb-4 mb-10 border-b border-gray-200 dark:border-gray-700">
              ...
              <div class="w-full px-4 mb-4 md:w-1/4">
                ...
                <p class="text-base font-semibold leading-4 text-blue-600 dark:text-gray-400">
                    {{Number::currency($pedido->valor_total, 'BRL')}}</p>
              </div>
              <div class="w-full px-4 mb-4 md:w-1/4">
                <p class="mb-2 text-sm leading-5 text-gray-600 dark:text-gray-400 ">
                  Metodo de Pagamento: </p>
                <p class="text-base font-semibold leading-4 text-gray-800 dark:text-gray-400 ">
                    {{$pedido->metodo_pagamento}} </p>
              </div>
            </div>
            <div class="px-4 mb-10">
              <div class="flex flex-col items-stretch justify-center w-full space-y-4 md:flex-row md:space-y-0 md:space-x-8">
                <div class="flex flex-col w-full space-y-6 ">
                  <h2 class="mb-2 text-xl font-semibold text-gray-700 dark:text-gray-400">Detalhes do Pedido</h2>
                  <div class="flex flex-col items-center justify-center w-full pb-4 space-y-4 border-b border-gray-200 dark:border-gray-700">
                    <div class="flex justify-between w-full">
                      ...
                      <p class="text-base leading-4 text-gray-600 dark:text-gray-400">{{Number::currency($pedido->valor_total, 'BRL')}}</p>
                    </div>
                  ...
                  <div class="flex items-center justify-between w-full">
                    ...
                    <p class="text-base font-semibold leading-4 text-gray-600 dark:text-gray-400">{{Number::currency($pedido->valor_total, 'BRL')}}</p>
                  </div>
                </div>
                    ...
                    <div class="flex items-center justify-center space-x-2">
                      ...
                      <div class="flex flex-col items-center justify-start">
                        <p class="text-lg font-semibold leading-6 text-gray-800 dark:text-gray-400">
                          Entrega<br><span class="text-sm font-normal">Chega em 24h</span>
                        </p>
                      </div>
                    </div>
