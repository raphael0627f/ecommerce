<div>
    {{-- Hero Section Start --}}
    <div class="w-full h-screen bg-gradient-to-r from-yellow-200 to-amber-200 py-10 px-4 sm:px-6 lg:px-8 mx-auto">
            ...
            <div class="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
                <div>
                    <h1
                        ...
                        Brilhe todos os dias com <span class="text-orange-600">Charme Jóias</span></h1>
    ...
    <div class="grid grid-cols-1 gap-6 lg:grid-cols-4 md:grid-cols-2">
        ...
        @foreach ($marcas as $marca)
            <div class="bg-white rounded-lg shadow-md dark:bg-gray-800" wire::key="{{ $marca->id }}">
                <a href="/produtos?selected_marcas[0]={{$marca->id}}" class="">
                    <img src="{{ url('storage/' . $marca->imagem) }}" alt="{{ $marca->nome }}" class="object-cover w-full h-64 rounded-t-lg">
                </a>
        ...
        <div class="max-w-[85rem] px-4 sm:px-6 lg:px-8 mx-auto">
          <div class="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 sm:gap-6">
            ...
            @foreach ($categorias as $categoria)
                <a class="group flex flex-col bg-white border shadow-sm rounded-xl hover:shadow-md transition dark:bg-slate-900 dark:border-gray-800 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" href="/produtos?selected_categorias[0]={{ $categoria->id }}" wire::key="{{ $categoria->id }}">
                    <div class="p-4 md:p-5">
                        <div class="flex justify-between items-center">
                            <div class="flex items-center">
                                <img class="h-[2.375rem] w-[2.375rem] rounded-full" src="{{ url('storage/' . $categoria->imagem) }}" alt="{{$categoria->nome}}">
                                <div class="ms-3">
