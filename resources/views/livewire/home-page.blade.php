                        ...
                        <div class="section-container">
                            <div class="row">
                                ...
                                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-6 header-center">
                                    <div class="site-logo">
                                        <a href="index.html">
                                            <img width="400" height="79" src="template/media/logo-white.png"
                                                    ...
                                                    <ul class="cart-list ">
                                                        <li class="mini-cart-item">
                                                            ...
                                                            <a href="shop-details.html" class="product-image"><img
                                                                    ...
                                                                    src="template/media/product/3.jpg" alt=""></a>
                                                        ...
                                                        <li class="mini-cart-item">
                                                            ...
                                                            <a href="shop-details.html" class="product-image"><img
                                                                    width="600" height="600"
                                                                    src="template/media/product/1.jpg" alt=""></a>
                            ...
                            <div class="section-container large p-l-r">
                                <div class="row">
                                    <div class="col-xl-3 col-lg-3 col-md-12 col-sm-12 col-12 header-left">
                                        <div class="site-logo">
                                            <a href="index.html">
                                                <img width="400" height="140" src="template/media/logo-white.png"
                                                    alt="Mojuri – Jewelry Store HTML Template" />
                                            </a>
                                        </div>
                                    </div>
                                        ...
                                        <div class="site-navigation">
                                            <nav id="main-navigation">
                                                <ul id="menu-main-menu" class="menu">
                                                    <li
                                                        class="level-0 menu-item menu-item-has-children current-menu-item">
                                                        ...
                                                        <ul class="sub-menu">
                                                            ...
                                                            <li>
                                                                <a href="shop-cart.html"><span
                                                                        class="menu-item-text">Shop - Cart</span></a>
                                                            </li>
                                                            <li>
                                                    ...
                                                    <li class="level-0 menu-item menu-item-has-children">
                                                        ...
                                                        <ul class="sub-menu">
                                                            <li>
                                                                <a href="page-login.html"><span
                                                                        class="menu-item-text">Login /
                                                                        Register</span></a>
                                                            </li>
                                                            <li>
                                                                <a href="page-forgot-password.html"><span
                                                                        class="menu-item-text">Forgot
                                                                        Password</span></a>
                                                            </li>
                                                            <li>
                                                            ...
                                                            <li>
                                                                <a href="page-about.html"><span
                                                                        class="menu-item-text">About Us</span></a>
                                                            </li>
                                                            <li>
                                                            ...
                                                            <li>
                                                                <a href="page-404.html"><span
                                                                        class="menu-item-text">Page 404</span></a>
                                                            </li>
                                                        </ul>
                                                    </li>
                                            ...
                                            <div class="mojuri-topcart dropdown light">
                                                <div class="dropdown mini-cart top-cart">
                                                    ...
                                                    <a class="dropdown-toggle cart-icon" href="#" role="button"
                                                        ...
                                                        aria-expanded="false">
                                                        <div class="icons-cart"><i
                                                                class="icon-large-paper-bag"></i><span
                                                                class="cart-count">2</span></div>
                                                    </a>
                                                    <div class="dropdown-menu cart-popup">
                                                        <div class="cart-empty-wrap">
                                                        ...
                                                        <div class="cart-list-wrap">
                                                            <ul class="cart-list ">
                                                                <li class="mini-cart-item">
                                                                    ...
                                                                    <a href="shop-details.html"
                                                                        class="product-image"><img width="600"
                                                                            height="600"
                                                                            src="template/media/product/3.jpg"
                                                                            alt=""></a>
                                                                    <a href="shop-details.html"
                                                                        class="product-name">Twin Hoops</a>
                                                                    <div class="quantity">Qty: 1</div>
                                                                    <div class="price">$150.00</div>
                                                                </li>
                                                                <li class="mini-cart-item">
                                                                    ...
                                                                    <a href="shop-details.html"
                                                                        class="product-image"><img width="600"
                                                                            height="600"
                                                                            src="template/media/product/1.jpg"
                                                                            alt=""></a>
                                                                    <a href="shop-details.html"
                                                                        class="product-name">Medium Flat Hoops</a>
                                                                    <div class="quantity">Qty: 1</div>
                                                                    <div class="price">$100.00</div>
                                                                </li>
                                                            </ul>
                                                            ...
                                                            <div class="buttons">
                                                                <a href="shop-cart.html"
                                                                    class="button btn view-cart btn-primary">View
                                                                    cart</a>
                                                                <a href="shop-checkout.html"
                                                                    class="button btn checkout btn-default">Check
                                                                    out</a>
                                                            </div>
                                                        </div>
                                                    </div>
                ...
                <div id="main-content" class="main-content">
                    <div id="primary" class="content-area">
                        <div id="content" class="site-content" role="main">
                                ...
                                <div class="block block-sliders auto-height color-white nav-center">
                                    <div class="slick-sliders" data-autoplay="true" data-dots="true" data-nav="true"
                                        ...
                                        <div class="item slick-slide">
                                            <div class="item-content">
                                                <div class="content-image">
                                                    <img width="1920" height="1080" src="template/media/slider/1-1.jpg"
                                                        alt="Image Slider">
                                                </div>
                                        ...
                                        <div class="item slick-slide">
                                            <div class="item-content">
                                                <div class="content-image">
                                                    <img width="1920" height="1080" src="template/media/slider/1-2.jpg"
                                                        alt="Image Slider">
                                                </div>
                                                <div class="item-info horizontal-start vertical-middle">
                                                    <div class="content">
                                        ...
                                        <div class="item slick-slide">
                                            <div class="item-content">
                                                <div class="content-image">
                                                    <img width="1920" height="1080" src="template/media/slider/1-3.jpg"
                                                        alt="Image Slider">
                                                </div>
                                                <div class="item-info horizontal-start vertical-middle">
                                                    <div class="content">
                                                                ...
                                                                <div class="banner-image">
                                                                    <a href="shop-grid-left.html">
                                                                        <img width="630" height="457"
                                                                            src="template/media/banner/banner-1-1.jpg"
                                                                            alt="Banner Image">
                                                                    </a>
                                                                </div>
                                                                ...
                                                                <div class="banner-image">
                                                                    <a href="shop-grid-left.html">
                                                                        <img width="450" height="457"
                                                                            src="template/media/banner/banner-1-2.jpg"
                                                                            alt="Banner Image">
                                                                    </a>
                                                                </div>
                                                        ...
                                                        <div class="bg-banner">
                                                            <div class="banner-wrapper banners">
                                                                <div class="banner-image">
                                                                    <a href="shop-grid-left.html">
                                                                        <img width="630" height="457"
                                                                            src="template/media/banner/banner-1-3.jpg"
                                                                            alt="Banner Image">
                                                                    </a>
                                                                </div>
                                                                <div class="banner-wrapper-infor">
                                                                ...
                                                                <a href="shop-grid-left.html">
                                                                    <div class="item-image animation-horizontal">
                                                                        <img width="258" height="258"
                                                                            src="template/media/product/cat-1.jpg"
                                                                            alt="Bracelets">
                                                                    </div>
                                                                </a>
                                                        ...
                                                        <div class="item item-product-cat slick-slide">
                                                            <div class="item-product-cat-content">
                                                                <a href="shop-grid-left.html">
                                                                    <div class="item-image animation-horizontal">
                                                                        <img width="258" height="258"
                                                                            src="template/media/product/cat-2.jpg"
                                                                            alt="Charms">
                                                                    </div>
                                                                </a>
                                                                <div class="product-cat-content-info">
                                                        ...
                                                        <div class="item item-product-cat slick-slide">
                                                            <div class="item-product-cat-content">
                                                                <a href="shop-grid-left.html">
                                                                    <div class="item-image animation-horizontal">
                                                                        <img width="258" height="258"
                                                                            src="template/media/product/cat-3.jpg"
                                                                            alt="Earrings">
                                                                    </div>
                                                                </a>
                                                                <div class="product-cat-content-info">
                                                        ...
                                                        <div class="item item-product-cat slick-slide">
                                                            <div class="item-product-cat-content">
                                                                <a href="shop-grid-left.html">
                                                                    <div class="item-image animation-horizontal">
                                                                        <img width="258" height="258"
                                                                            src="template/media/product/cat-4.jpg"
                                                                            alt="Necklaces">
                                                                    </div>
                                                                </a>
                                                                <div class="product-cat-content-info">
                                                        ...
                                                        <div class="item item-product-cat slick-slide">
                                                            <div class="item-product-cat-content">
                                                                <a href="shop-grid-left.html">
                                                                    <div class="item-image animation-horizontal">
                                                                        <img width="258" height="258"
                                                                            src="template/media/product/cat-5.jpg"
                                                                            alt="Rings">
                                                                    </div>
                                                                </a>
                                                                <div class="product-cat-content-info">
                                            ...
                                            <div class="intro-wrap">
                                                ...
                                                <div class="intro-item">
                                                    <div class="icon">
                                                        <span class="wrap animation-horizontal">
                                                            <svg xmlns="http://www.w3.org/2000/svg" id="Capa_1"
                                                                height="100%" viewBox="0 0 512.001 512.001"
                                                                width="100%">
                                                                <g>
                                                                    <g>
                                                                        <g>
                                                    ...
                                                    <div class="content">
                                                        ...
                                                        <div class="text">Nullam quis ante. Pellentesque libero tortor,
                                                            tincidunt et, tinciduntamet est.In hac habitasse platea
                                                            dictumst. Praesent nec nisl a purus blandit viverra</div>
                                                    </div>
                                                </div>
                                                <div class="intro-item">
                                                    <div class="icon">
                                                        <span class="wrap animation-horizontal">
                                                            <svg xmlns="http://www.w3.org/2000/svg" id="Capa_1"
                                                                height="100%" viewBox="0 0 511.985 511.985"
                                                                width="100%">
                                                                <g>
                                                                    <g>
                                                                        <path
                                        ...
                                        <div class="section-column right">
                                            <a href="#">
                                                <img class="hover-opacity" width="820" height="674"
                                                    src="template/media/banner/intro-1.jpg" alt="intro">
                                            </a>
                                        </div>
                                    </div>
                                </div>
                                                                    ...
                                                                    <div class="products-thumb">
                                                                        ...
                                                                        <div class="product-thumb-hover">
                                                                            <a href="shop-details.html">
                                                                                ...
                                                                                <img width="600" height="600"
                                                                                    src="template/media/product/1-2.jpg"
                                                                    ...
                                                                    <div class="products-content">
                                                                        <div class="contents">
                                                                            ...
                                                                            <h3 class="product-title"><a
                                                                                    href="shop-details.html">Medium Flat
                                                                                    Hoops</a></h3>
                                                                ...
                                                                <div class="products-entry clearfix product-wapper">
                                                                    <div class="products-thumb">
                                                                        ...
                                                                        <div class="product-thumb-hover">
                                                                            <a href="shop-details.html">
                                                                                <img width="600" height="600"
                                                                                    src="template/media/product/2.jpg"
                                                                                    class="post-image" alt="">
                                                                                <img width="600" height="600"
                                                                                    src="template/media/product/2-2.jpg"
                                                                                    class="hover-image back" alt="">
                                                                            </a>
                                                                        </div>
                                                                        <div class="product-button">
                                                                    ...
                                                                    <div class="products-content">
                                                                        <div class="contents">
                                                                            ...
                                                                            <h3 class="product-title"><a
                                                                                    href="shop-details.html">Bold Pearl
                                                                                    Hoop Earrings</a></h3>
                                                                            <span class="price">
                                                                                <del
                                                                        ...
                                                                        <div class="product-thumb-hover">
                                                                            <a href="shop-details.html">
                                                                                <img width="600" height="600"
                                                                                    ...
                                                                                    class="post-image" alt="">
                                                                                <img width="600" height="600"
                                                                                    src="template/media/product/3-2.jpg"
                                                                                    class="hover-image back" alt="">
                                                                            </a>
                                                                        </div>
                                                                        <div class="product-button">
                                                                ...
                                                                <div class="products-entry clearfix product-wapper">
                                                                    <div class="products-thumb">
                                                                        ...
                                                                        <div class="product-thumb-hover">
                                                                            <a href="shop-details.html">
                                                                                <img width="600" height="600"
                                                                                    src="template/media/product/4.jpg"
                                                                                    class="post-image" alt="">
                                                                                <img width="600" height="600"
                                                                                    src="template/media/product/4-2.jpg"
                                                                                    class="hover-image back" alt="">
                                                                            </a>
                                                                        </div>
                                                                        <div class="product-button">
                                                                    ...
                                                                    <div class="products-content">
                                                                        <div class="contents">
                                                                            ...
                                                                            <h3 class="product-title"><a
                                                                                    href="shop-details.html">Yilver And
                                                                ...
                                                                <div class="products-entry clearfix product-wapper">
                                                                    <div class="products-thumb">
                                                                        ...
                                                                        <div class="product-thumb-hover">
                                                                            <a href="shop-details.html">
                                                                                <img width="600" height="600"
                                                                                    src="template/media/product/13.jpg"
                                                                                    class="post-image" alt="">
                                                                                <img width="600" height="600"
                                                                                    src="template/media/product/13-2.jpg"
                                                                                    class="hover-image back" alt="">
                                                                            </a>
                                                                        </div>
                                                                        <div class="product-button">
                                                                ...
                                                                <div class="banner-image">
                                                                    <a href="shop-grid-left.html">
                                                                        <img width="856" height="496"
                                                                            src="template/media/banner/banner-1-4.jpg"
                                                                            alt="Banner Image">
                                                                    </a>
                                                                </div>
                                                                <div class="banner-wrapper-infor">
                                                        ...
                                                        <div class="bg-banner">
                                                            <div class="banner-wrapper banners">
                                                                <div class="banner-image">
                                                                    <a href="shop-grid-left.html">
                                                                        <img width="856" height="496"
                                                                            src="template/media/banner/banner-1-5.jpg"
                                                                            alt="Banner Image">
                                                                    </a>
                                                                </div>
                                                                <div class="banner-wrapper-infor">
                            ...
                            <section
                                class="section section-padding background-img bg-img-2 m-b-70 p-t-140 p-b-70 m-t-n-130">
                                <div class="section-container">
                                    <!-- Block Testimonial -->
                                                        ...
                                                        <div class="testimonial-content">
                                                            <div class="item">
                                                                <div class="testimonial-item">
                                                                    ...
                                                                    <h2 class="testimonial-title">“Amazing piece of
                                                                        history”</h2>
                                                                ...
                                                                <div class="testimonial-image image-position-top">
                                                                    <div class="thumbnail">
                                                                        <img width="110" height="110"
                                                                            src="template/media/testimonial/1.jpg"
                                                                            alt="">
                                                                    </div>
                                                                    <div class="testimonial-info">
                                                                        <h2 class="testimonial-customer-name">Robet
                                                                            Smith</h2>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="testimonial-content">
                                                            <div class="item">
                                                                <div class="testimonial-item">
                                                                    ...
                                                                    <h2 class="testimonial-title">“Fabulous Grounds”
                                                                    </h2>
                                                                    <div class="testimonial-excerpt">
                                                                        Blood bank canine teeth larynx occupational
                                                                        therapist oncologist optician plaque spinal tap
                                                                ...
                                                                <div class="testimonial-image image-position-top">
                                                                    <div class="thumbnail">
                                                                        <img width="110" height="110"
                                                                            src="template/media/testimonial/2.jpg"
                                                                            alt="">
                                                                    </div>
                                                                    <div class="testimonial-info">
                                                                        <h2 class="testimonial-customer-name">Saitama
                                                                            One</h2>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="testimonial-content">
                                                            <div class="item">
                                                                <div class="testimonial-item">
                                                                    ...
                                                                    <h2 class="testimonial-title">“Great vineyard tour
                                                                        and tasting!”</h2>
                                                                    <div class="testimonial-excerpt">
                                                                        Blood bank canine teeth larynx occupational
                                                                        therapist oncologist optician plaque spinal tap
                                                                ...
                                                                <div class="testimonial-image image-position-top">
                                                                    <div class="thumbnail">
                                                                        <img width="110" height="110"
                                                                            src="template/media/testimonial/3.jpg"
                                                                            alt="">
                                                                    </div>
                                                                    <div class="testimonial-info">
                                                                        <h2 class="testimonial-customer-name">Sara
                                                                            Colinton</h2>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="testimonial-content">
                                                            <div class="item">
                                                                ...
                                                                <div class="testimonial-image image-position-top">
                                                                    <div class="thumbnail">
                                                                        <img width="110" height="110"
                                                                            src="template/media/testimonial/4.jpg"
                                                                            alt="">
                                                                    </div>
                                                                    <div class="testimonial-info">
                                                                        <h2 class="testimonial-customer-name">Shetty
                                                                            Jamie</h2>
                                                                    </div>
                                                                </div>
                                                            </div>
                                    ...
                                    <div class="block block-image slider">
                                        <div class="block-widget-wrap">
                                            <div class="slick-wrap">
                                                <div class="slick-sliders" data-nav="0" data-columns4="1"
                                                    data-columns3="2" data-columns2="3" data-columns1="4"
                                                    data-columns1440="4" data-columns="5">
                                                    <div class="item slick-slide">
                                                        <div class="item-image animation-horizontal">
                                                            <a href="#">
                                                                <img width="450" height="450"
                                                                    src="template/media/brand/1.jpg" alt="Brand 1">
                                                            </a>
                                                        </div>
                                                    </div>
                                                    <div class="item slick-slide">
                                                        <div class="item-image animation-horizontal">
                                                            <a href="#">
                                                                <img width="450" height="450"
                                                                    src="template/media/brand/2.jpg" alt="Brand 2">
                                                            </a>
                                                        </div>
                                                    </div>
                                                    <div class="item slick-slide">
                                                        <div class="item-image animation-horizontal">
                                                            <a href="#">
                                                                <img width="450" height="450"
                                                                    src="template/media/brand/3.jpg" alt="Brand 3">
                                                            </a>
                                                        </div>
                                                    </div>
                                                    <div class="item slick-slide">
                                                        <div class="item-image animation-horizontal">
                                                            <a href="#">
                                                                <img width="450" height="450"
                                                                    src="template/media/brand/4.jpg" alt="Brand 4">
                                                            </a>
                                                        </div>
                                                    </div>
                                                    <div class="item slick-slide">
                                                        <div class="item-image animation-horizontal">
                                                            <a href="#">
                                                                <img width="450" height="450"
                                                                    src="template/media/brand/5.jpg" alt="Brand 5">
                                                            </a>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="col-lg-3 col-md-6 column-1">
                                        <div class="block block-menu m-b-20">
                                            ...
                                            <div class="block-content">
                                                <ul>
                                                    <li>
                                                        <span>Head Office:</span> 26 Wyle Cop, Shrewsbury, Shropshire,
                                                        SY1 1XD
                                                    </li>
                                                    <li>
                            ...
                            <table id="product-table" class="product-table">
                                <thead>
                                    <tr>
                                        ...
                                        <th>
                                            <a href="shop-details.html">Twin Hoops</a> <span
                                                    ...
                                                    <div class="slick-wrap">
                                                        <div class="slick-sliders image-additional" data-dots="true"
                                                            ...
                                                            <div class="img-thumbnail slick-slide">
                                                                <a href="template/media/product/3.jpg"
                                                                    class="image-scroll" title="">
                                                                    <img width="900" height="900"
                                                                        src="template/media/product/3.jpg" alt="">
                                                                </a>
                                                            </div>
                                                            <div class="img-thumbnail slick-slide">
                                                                <a href="template/media/product/3-2.jpg"
                                                                    class="image-scroll" title="">
                                                                    <img width="900" height="900"
                                                                        src="template/media/product/3-2.jpg" alt="">
                                                                </a>
                                                            </div>
                                                        </div>
                                                    </div>
